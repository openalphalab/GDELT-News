...
- **Empty checks:** no rows means no Parquet upload. Coverage is recorded separately; missing recent files are retried for up to 24 hours. Polling does not create duplicate observations.
